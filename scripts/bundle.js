	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				" because the majority of candidates search for available positions using keywords, make sure you use all relevant keywords in your postion."
			),
			React.createElement(
				"div",
				null,
			...
			React.createElement(
				...
				" The purpose of posting a job is to spark a candidates interest in the available postion. When job postings have a detailed descriptions, candidates tend to apply to them more."
			),
			React.createElement(
				"div",
				null,
				...
				" Do not limit your job postings to a restricted area around the jobs location. Make sure you include the surrounding cities and metropolitan areas in your searches."
			),
			React.createElement(
				"div",
				null,
				...
				" Even though you may not want to give an exact compensation, give a range. Make sure to point out any bonuses, commissions, or nonmonetary compensation, as well"
			)
		);
	}
});
...
React.render(React.createElement(
	...
	React.createElement(TipsComponent, null),
	React.createElement(InputComponent, null)
), mainContent);

},{"./components/inputComponent.js":157,"./components/navComponent.js":158,"./components/tipsComponent.js":159,"react":156}]},{},[160])
